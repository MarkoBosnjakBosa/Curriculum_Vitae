...
export const createAdministrator = async () => {
  ...
  const update = { $setOnInsert: { username, password: hashedPassword, firstName: "", lastName: "", email: "", telephone: "", address: "", address_de: "", birthday: "", birthday_de: "", languages: "", languages_de: "", profession: "", profession_de: "", linkedIn: "", xing: "", gitHub: "", avatar, authentication: { isEnabled: false, secret: "" } } };
